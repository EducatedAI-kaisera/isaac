...
export function Logo(props) {
	return (
		<div className="flex items-center">
			...
			<span className="text-black font-semibold text-xl"> Isaac </span>
		</div>
	);
}

export function LogoInApp(props) {
	return (
		<div className="flex items-center">
			<svg viewBox="0 0 40 40" aria-hidden="true" {...props}>
				<Logomark width="40" height="40" className="fill-primary" />
			</svg>
			<span className="text-foreground font-semibold text-xl"> Isaac </span>
		</div>
	);
}
